...
# from helpers.viz import plot_loss_metrics, HTMLVisualizer
#
#
# # Calculate metrics
...
#             args.id += '-LogFreq'
#         args.id += '-{}{}-{}{}-{}{}'.format(
#             args.arch_frame, args.img_activation, args.arch_sound, args.sound_activation, args.arch_synthesizer,
